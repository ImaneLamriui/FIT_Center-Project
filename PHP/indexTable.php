...
<body>
    ...
    <div class="container">
        ...
        <div class="row ">
            <table id="example" class="display table table-striped table-responsive table-hover border border-light-4 table-bordered text-secondary" style=" width:100%">
                <thead>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                language: {
                    ...
                    "search": "Buscar: ",
                    "lengthMenu": "Mostrar _MENU_ registros del menu",
                    "info": "Mostrar_START_ del _END_ del _TOTAL_ de entradas",
                    "paginate": {
                        "first": "Primero",
                        "last": "Ultimo",
                        "next": "Siguiente",
